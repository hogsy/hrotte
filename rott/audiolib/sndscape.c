...
char * SOUNDSCAPE_ErrorString
	...
	case SOUNDSCAPE_Error :ErrorString = SOUNDSCAPE_ErrorString( SOUNDSCAPE_ErrorCode );
		break;

	case SOUNDSCAPE_Ok :ErrorString = "SoundScape ok.";
		break;
	...
	case SOUNDSCAPE_MissingProductInfo :ErrorString = "Missing 'Product' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingPortInfo :ErrorString = "Missing 'Port' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingDMAInfo :ErrorString = "Missing 'DMA' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingIRQInfo :ErrorString = "Missing 'IRQ' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingSBIRQInfo :ErrorString = "Missing 'SBIRQ' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingSBENABLEInfo :ErrorString = "Missing 'SBEnable' field in SNDSCAPE.INI file for SoundScape.";
		break;

	case SOUNDSCAPE_MissingWavePortInfo :ErrorString = "Missing 'WavePort' field in SNDSCAPE.INI file for SoundScape.";
		break;
	...
	case SOUNDSCAPE_NoSoundPlaying :ErrorString = "No sound playing on SoundScape.";
		break;

	case SOUNDSCAPE_InvalidSBIrq :ErrorString = "Invalid SoundScape Irq in SBIRQ field of SNDSCAPE.INI.";
		break;

	case SOUNDSCAPE_UnableToSetIrq :ErrorString = "Unable to set SoundScape IRQ.  Try selecting an IRQ of 7 or below.";
		break;

	case SOUNDSCAPE_DmaError :ErrorString = DMA_ErrorString( DMA_Error );
		break;

	case SOUNDSCAPE_DPMI_Error :ErrorString = "DPMI Error in SoundScape.";
		break;

	case SOUNDSCAPE_OutOfMemory :ErrorString = "Out of conventional memory in SoundScape.";
		break;

	default :ErrorString = "Unknown SoundScape error code.";
		break;
	}
...
static void __interrupt
__far SOUNDSCAPE_ServiceInterrupt
	(
		void
	) {
	// save stack
...
static void pcm_format
	...
	case 11025:format = 0x03;
		break;

	case 22050:format = 0x07;
		break;

	case 44100:format = 0x0b;
		break;
...
static int SOUNDSCAPE_FindCard
	...
	if ( !SOUNDSCAPE_Config.OldIRQs ) {
		...
		case 9 :SOUNDSCAPE_Config.IRQIndx = 0;
			break;

		case 5 :SOUNDSCAPE_Config.IRQIndx = 1;
			break;

		case 7 :SOUNDSCAPE_Config.IRQIndx = 2;
			break;

		default :SOUNDSCAPE_Config.IRQIndx = 3;
			break;
		}
	} else {
		switch ( SOUNDSCAPE_Config.WaveIRQ ) {
		...
		case 5 :SOUNDSCAPE_Config.IRQIndx = 2;
			break;

		case 7 :SOUNDSCAPE_Config.IRQIndx = 1;
			break;
